      ...
      <div className="grid grid-cols-1 md:grid-cols-3 border-[2.5px] border-ink divide-x-[2.5px] divide-ink">
        {props.map(({ icon: Icon, title, body }, i) => (
          <Reveal key={title} delayMs={i * 90}>
            <div className="group p-7 h-full transition-colors duration-300 hover:bg-paper-alt/60">
              <span className="hard-sm w-[46px] h-[46px] bg-blue flex items-center justify-center mb-4.5 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3">
