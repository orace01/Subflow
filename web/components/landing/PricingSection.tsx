...
const proFeatures = [
  ...
  "Plusieurs boîtes mail connectées",
  ...
  return (
    ...
    <div id="tarifs" className="max-w-[1400px] mx-auto px-8 pt-24 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5 items-stretch">
        {/* Essai gratuit */}
        <Reveal>
          <div className="group hard hard-hover bg-blue p-6.5 flex flex-col h-full relative cursor-default">
        ...
        {/* Gratuit */}
        <Reveal delayMs={80}>
          <Card className="hard-sm hard-hover p-6.5 flex flex-col h-full cursor-default">
            ...
            <LinkButton href="/inscription?plan=gratuit" variant="ghost" className="mt-auto">
        ...
        <Reveal delayMs={160}>
          <Card className="hard-sm hard-hover p-6.5 flex flex-col h-full cursor-default">
            ...
            <LinkButton href="/inscription?plan=pro" variant="ghost" className="mt-auto">
              Passer en Pro
            </LinkButton>
          </Card>
        </Reveal>
        ...
        <Reveal delayMs={240}>
          <Card className="hard-sm hard-hover p-6.5 flex flex-col h-full cursor-default">
            ...
            <LinkButton href="/inscription?plan=annuel" variant="ghost" className="mt-auto">
